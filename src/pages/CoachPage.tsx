...
export function CoachPage() {
  const { coachMessages, sendCoachMessage, loading, error, clearError } =
    useFitness();
  ...
  return (
    <Stack spacing={4}>
      <PageHeader
        title="AI Coach"
        subtitle="Ask workout, diet, recovery, or general fitness questions and keep the conversation on the backend."
      />
                ...
                {coachMessages.length > 0 ? (
                  ...
                  <Card padding="lg">
                    <Typography variant="body2" color="text.secondary">
                      No messages yet. Try one of the starter prompts on the
                      right.
                    </Typography>
                  </Card>
                )}
        ...
        <Grid size={{ xs: 12, lg: 5 }}>
          <Stack spacing={3}>
            <AIResponseCard
              ...
              subtitle="Quick questions to begin the conversation"
            ...
            <Card padding="lg">
              <Stack spacing={1.25}>
                ...
                <Typography
                  ...
                  sx={{ lineHeight: 1.75 }}
                >
                  Messages are posted to the backend, which can swap between AI
                  providers later without changing the UI.
                </Typography>
              </Stack>
            </Card>
          </Stack>
